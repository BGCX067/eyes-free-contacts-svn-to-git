...
public class SlideDialView extends TextView {
  ...
  protected  static String dialingState = "";
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
    ...
    if (newNumberEntered) {
      ...
      parent.tts.speak(currentValue, 0, null);
      dialedNumber = dialedNumber + currentValue;
      dialingState = dialedNumber + currentValue;
      invalidate();
      return true;
    }
    confirmed = false;
  ...
  private void deleteNumber() {
    ...
    if (dialedNumber.length() > 0) {
      ...
      dialingState = dialingState.substring(0, dialingState.length() - 1);
    } else {
      deletedNum = "";
    }
